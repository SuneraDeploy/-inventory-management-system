...
class company_sprite extends StatelessWidget {
  const company_sprite({super.key});
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("images/stock_sprite.png"),
              fit: BoxFit.fill,
            ),
          ),
        ),
...
class ProductTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: collection
          .where('product_id', isGreaterThanOrEqualTo: 'SP')
          .where('product_id', isLessThan: 'SQ') // Limits to "CC" prefix
          .snapshots(),

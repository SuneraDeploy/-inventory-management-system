...
class company_fanta extends StatelessWidget {
  const company_fanta({super.key});
...
class ProductTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: collection
          .where('product_id', isGreaterThanOrEqualTo: 'FN')
          .where('product_id', isLessThan: 'FO') // Limits to "CC" prefix
          .snapshots(),

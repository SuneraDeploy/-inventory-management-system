...
class company_coccola extends StatelessWidget {
  const company_coccola({super.key});
...
class ProductTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: collection
          .where('product_id', isGreaterThanOrEqualTo: 'CC')
          .where('product_id', isLessThan: 'CD') // Limits to "CC" prefix
          .snapshots(),

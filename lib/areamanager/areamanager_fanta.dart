...
class areamanager_fanta extends StatelessWidget {
  final String userId;
  const areamanager_fanta({super.key, required this.userId});
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("images/areamanager_view_to_others_fanta.png"),
              fit: BoxFit.fill,
            ),
          ),
        ),
...
class DataDisplayTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: fetchDocumentsWithPrefix(userId, "FN"),

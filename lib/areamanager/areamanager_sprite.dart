...
class areamanager_sprite extends StatelessWidget {
  final String userId;
  const areamanager_sprite({super.key, required this.userId});
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("images/areamanager_view_to_others_sprite.png"),
              fit: BoxFit.fill,
            ),
          ),
        ),
...
class DataDisplayTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: fetchDocumentsWithPrefix(userId, "SP"),

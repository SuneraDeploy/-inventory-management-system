...
class stock_portello extends StatelessWidget {
  final String shopId;
  final String title;

  const stock_portello({super.key, required this.shopId, required this.title});
...
class DataDisplayTableWithPrefix extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: fetchDocumentsWithPrefix(shopId, "PO"),

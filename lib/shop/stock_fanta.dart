...
class stock_fanta extends StatelessWidget {
  final String shopId;
  final String title;

  const stock_fanta({super.key, required this.shopId, required this.title});
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("images/stock_fanta.png"),
              fit: BoxFit.fill,
            ),
          ),
        ),
...
class DataDisplayTableWithPrefix extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: fetchDocumentsWithPrefix(shopId, "FN"),

...
class stock_sprite extends StatelessWidget {
  final String shopId;
  final String title;

  const stock_sprite({super.key, required this.shopId, required this.title});
...
class DataDisplayTableWithPrefix extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: fetchDocumentsWithPrefix(shopId, "SP"),

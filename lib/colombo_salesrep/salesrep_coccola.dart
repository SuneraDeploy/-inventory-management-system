...
class Salesrep_Stock_Coccola extends StatelessWidget {
  final String salesRepId;
  final String title;
  const Salesrep_Stock_Coccola({super.key, required this.salesRepId, required this.title});
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("images/salesrep_view_cocacola.png"),
              fit: BoxFit.fill,
            ),
          ),
        ),
...
class DataDisplayTableWithPrefix extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: fetchDocumentsWithPrefix(salesRepId, "CC"),
